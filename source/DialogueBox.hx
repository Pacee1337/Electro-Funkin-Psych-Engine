...
class DialogueBox extends FlxSpriteGroup
{
	...
	override function update(elapsed:Float)
	{
		...
		if (PlayState.SONG.song.toLowerCase() == 'idiot-bot')
			portraitLeft.visible = false;
		if (PlayState.SONG.song.toLowerCase() == 'rise')
		{
			portraitLeft.visible = false;
			...
			if (dialogueEnded)
			{
				...
				if (dialogueList[1] == null && dialogueList[0] != null)
				{
					if (!isEnding)
					{
						...
						if (PlayState.SONG.song.toLowerCase() == 'warning' || PlayState.SONG.song.toLowerCase() == 'rise')
	...
	function startDialogue():Void
	{
		...
		switch (curCharacter)
		{
			case 'dad':
				...
				{
					if (PlayState.SONG.song.toLowerCase() == 'warning') portraitLeft.visible = true;
